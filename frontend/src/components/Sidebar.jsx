...
const Sidebar = ({ onNewChat }) => {
  ...
  const handleNewChatClick = () => {
    ...
    setIsSidebarOpen(false); // Cerrar el sidebar al hacer clic en un enlace en móviles
  };
  ...
  return (
    <>
      ...
      <AnimatePresence>
        <motion.div
          className={`fixed top-0 left-0 h-screen w-64 bg-white shadow-lg flex flex-col p-4 z-40 transform transition-transform duration-300 md:translate-x-0 ${
            isSidebarOpen ? "translate-x-0" : "-translate-x-full"
          } md:static md:w-64 md:h-screen md:flex md:flex-col md:p-4 md:shadow-lg md:bg-white md:transition-none`}
          initial={{ x: -256 }}
