...
import logoIA from '../assets/logoAPP.png';
...
function Login() {
  ...
  const handleGitHubLogin = async () => {
    setError('Inicio de sesión con GitHub no está implementado aún.');
  };
    ...
    >
      <div className="w-full max-w-md p-8">
        ...
        <div className="space-y-3">
          ...
          >
            <svg className="w-5 h-5 transition-transform duration-200 group-hover:translate-x-1" viewBox="0 0 24 24">
              <path
                fill="#4285F4"
