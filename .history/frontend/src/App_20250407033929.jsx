  ...
  useEffect(() => {
    ...
    try {
      const unsubscribe = auth.onAuthStateChanged((currentUser) => {
        console.log(
          "LandingPage: Estado de usuario actualizado:",
      ...
      console.error(
        "LandingPage: Error al verificar el estado de autenticación:",
        error
      );
    }
  }, []);
          ...
          <div className="relative z-10">
            ...
            >
              ...
              <nav className="hidden md:flex gap-4 md:gap-6">
                ...
                {/* Eliminamos el botón de "Cerrar Sesión" del header */}
              </nav>
              ...
              {isMenuOpen && (
                ...
                >
                  <nav className="flex flex-col gap-6 text-center">
                    ...
                    {/* Eliminamos el botón de "Cerrar Sesión" del menú móvil */}
                  </nav>
                </motion.div>
              )}
            </AnimatePresence>
                  ...
                  >
                    ...
                    <div className="absolute inset-0 rounded-full overflow-hidden">
                      <motion.div
                        ...
                        style={{
                          background:
                            "linear-gradient(90deg, #d8b4fe, #9333ea, #d8b4fe)",
        ...
        <div className="relative z-0">
          ...
          >
            ...
            <p className="text-center text-gray-300 mb-8 md:mb-12 max-w-md md:max-w-3xl mx-auto text-sm md:text-base">
              Descubre todas las herramientas que ExpensIA pone a tu disposición
              para optimizar tus finanzas de manera inteligente y eficiente.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
              ...
              >
                ...
                <p className="text-gray-400 text-sm md:text-base">
                  Monitorea tus gastos al instante y recibe alertas cuando
                  detectamos patrones inusuales.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-400 text-sm md:text-base">
                  Visualiza tu futuro financiero con proyecciones basadas en tus
                  hábitos actuales.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-400 text-sm md:text-base">
                  Nuestro sistema de IA clasifica automáticamente tus
                  transacciones con precisión.
                </p>
              </motion.div>
              ...
              >
                ...
                <div className="text-purple-400 mb-4">
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth="2"
                      d="M21 3H3v6h18V3zM3 9h18v12H3V9zm4 6h10v2H7v-2z"
                    />
                  </svg>
                </div>
                <h3 className="text-lg md:text-xl font-semibold mb-2">
                ...
                <p className="text-gray-400 text-sm md:text-base">
                  Crea y gestiona presupuestos adaptados a tus necesidades
                  específicas.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-400 text-sm md:text-base">
                  Accede a tus finanzas desde cualquier dispositivo, en
                  cualquier momento.
                </p>
              </motion.div>
            </div>
          ...
          >
            ...
            <p className="text-center text-gray-300 mb-8 md:mb-12 max-w-md md:max-w-3xl mx-auto text-sm md:text-base">
              Tu plan gratuito se asigna automáticamente. Aquí puedes actualizar
              a un plan superior para desbloquear todas las funcionalidades.
            </p>
            ...
            <div className="flex justify-center mb-6 md:mb-8">
              <div className="flex bg-gray-800 rounded-full p-1">
                <button
                  ...
                  className={`px-3 py-1 md:px-4 md:py-2 rounded-full transition duration-300 text-sm md:text-base ${
                    pricePlan === "monthly"
          ...
          <footer className="py-8 px-4 bg-gray-800 text-center">
            <div className="max-w-6xl mx-auto">
              ...
              <p className="text-gray-400 mb-6 text-sm md:text-base">
                Gestiona tus finanzas con inteligencia artificial. Optimiza tus
                gastos y alcanza tus metas financieras.
              </p>
              ...
              <p className="text-gray-500 text-sm">
                © {new Date().getFullYear()} ExpensIA. Todos los derechos
                reservados.
              </p>
            </div>
          </footer>
